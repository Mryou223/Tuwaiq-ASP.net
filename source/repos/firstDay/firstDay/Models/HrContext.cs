...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=WorkArea\\SQLEXPRESS;Database=HR;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Country>(entity =>
        {
            entity.HasKey(e => e.CountryId).HasName("PK__countrie__7E8CD055E089202D");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__departme__C22324221D5B7B06");
        ...
        {
            entity.HasKey(e => e.DependentId).HasName("PK__dependen__F25E28CEA6D5392C");
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__employee__C52E0BA897F42F8E");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__jobs__6E32B6A569EDE10C");
        ...
        {
            entity.HasKey(e => e.LocationId).HasName("PK__location__771831EABC7EC482");
        ...
        {
            entity.HasKey(e => e.RegionId).HasName("PK__regions__01146BAE6C105376");
